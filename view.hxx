...
public:
    ...
    ge211::Dimensions initial_window_dimensions() const {return {800, 600};};
...
//sets the color choice based on number given more the controller
    void set_color_choice(std::string);
...
private:
    ...
    ge211::Text_sprite theme_change_{"Press b r g or p to change the theme.", sans_small_};
    ...
    ge211::Image_sprite C2_{"2C.png"}, C3_{"3C.png"}, C4_{"4C.png"},
                        ...
                        SA_{"AS.png"},
                        red_back_{"red_back.png"},
                        blue_back_{"blue_back.png"},
                        green_back_{"green_back.png"},
                        purple_back_{"purple_back.png"},
                        go_cats_{"go_cats.png"};
